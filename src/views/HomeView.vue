...
const activities = ref([
  {
    ...
    description:
      '携手清理深圳湾海滩垃圾，保护海洋生态环境。需要 20 名志愿者，欢迎具备基本体能的志愿者参与。',
  },
  {
    id: 2,
    title: '珠海情侣路海岸清洁',
    ...
    >
      <div class="bg-white rounded-lg w-full max-w-lg p-6">
        ...
        <div class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1"
              >手机号码 <span class="text-red-500">*</span></label
            >
            <input
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1"
              >紧急联系人 <span class="text-red-500">*</span></label
            >
            <input
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1"
              >紧急联系人电话 <span class="text-red-500">*</span></label
            >
            <input
